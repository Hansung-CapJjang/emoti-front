...
void _showFinalStampDialog() async {
  ...
  if (userProvider.hasReceivedStampToday()) {
  ...
  try {
    ...
    // 날짜 포함 도장 추가
    userProvider.addTodayStamp(resultStamp);
